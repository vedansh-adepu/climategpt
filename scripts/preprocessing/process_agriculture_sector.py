#!/usr/bin/env python3
"""
Agriculture Sector Preprocessing Pipeline

Processes EDGAR v2024 Agriculture sector emissions data:
- Livestock, rice, soil, and manure emissions
...
class AgricultureProcessor(TransportProcessor):
    """Process Agriculture sector emissions data."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Process Agriculture sector emissions")
    parser.add_argument(
        '--raw-data',
        type=Path,
        required=True,
